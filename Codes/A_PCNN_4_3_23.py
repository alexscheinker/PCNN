...
for n_ep in np.arange(N_epochs):
    ...
    for n_t in np.arange(Nt):
        ...
        loss_B, gA, loss_Bx, loss_By, loss_Bz = train_step(model_A, z_input[n_t:n_t+1],
                     Jx[n_t:n_t+1], Jy[n_t:n_t+1], Jz[n_t:n_t+1], Qnz[n_t:n_t+1],
                     Bx[n_t:n_t+1], By[n_t:n_t+1], Bz[n_t:n_t+1])
